...
% Background stag watermark (half off page on right side)
\usebackgroundtemplate{%
  \tikz[overlay,remember picture]
  \node[opacity=0.2, at=(current page.east), anchor=west, xshift=-6cm, yshift=0cm] {
    \includegraphics[height=10cm]{../images/surrey-stag.png}
  };
}
...
\lstset{
    ...
    keywordstyle=\color{scrblue}\bfseries,
...
\textcolor{scrblue}{\textbf{How would you split it?}}
...
\vspace{0.3em}
\begin{center}
\textcolor{scrblue}{\textbf{Simple, but surprisingly hard to beat!}}
\end{center}
\end{frame}
