...
\leavevmode%                                                                                                                   
\hbox{%                                                                                                                        
    \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.0ex,dp=0.9ex,left]{author in head/foot}%                                        
    \hspace*{1.2ex}\insertshortauthor                                                                                          
    \end{beamercolorbox}%                                                                                                        
    \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.0ex,dp=0.9ex,right]{date in head/foot}%                                         
    \hspace*{1.2ex}\insertframenumber{} / \inserttotalframenumber\hspace*{1.2ex}                             
    \end{beamercolorbox}%                                                                                                        
}%                                                                                                                             
\vskip0pt%                                                                                                                     
}
...
\vspace{0.5em}
\normalsize
\hyperlink{GitHub Link}{github.com/Surrey-Capital-Research/deep-dive-into-portfolio-optimisation}
